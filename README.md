...
## 🧠 MindWatch – Mental Health Analyzer

A Machine Learning powered web application that predicts mental health conditions from user input using TF-IDF and Logistic Regression.
